...
from predict.Data import StateData2
...
class ReducedAnodePrediction:
    ...
    def __init__(self, trained_params="", min_max=''):
        self.ode = ODENet(device=torch.device('cuda'),
                          data_dim=4,
                          hidden_dim=10,
                          output_dim=1,
    ...
    def eval_norm(self, t):
        t[0, 0] = t[0, 0] / 360
        t[0, 1] = t[0, 1] / (self.mm.w_ball_max - self.mm.w_ball_min)
        t[0, 2] = t[0, 2] / 360
        t[0, 3] = t[0, 3] / (self.mm.w_zero_max - self.mm.w_zero_min)
